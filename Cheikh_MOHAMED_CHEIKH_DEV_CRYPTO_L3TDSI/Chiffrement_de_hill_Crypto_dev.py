...
def cipher_encryption():
    msg = input("Enter your message clear : ").upper()
    msg = msg.replace(" ", "")
    ...
    key = input("Enter 4 letter of the matrix 2*2 : ").upper()
    key = key.replace(" ", "")
...
def cipher_decryption():
    msg = input("Enter your encrypted message : ").upper()
    msg = msg.replace(" ", "")
